...
public class ForgetPasswordRepository {
    ...
    public ForgetPasswordRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<HashMap<String,String>> getLoginStatus(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().forgetpassword(requestBody);
