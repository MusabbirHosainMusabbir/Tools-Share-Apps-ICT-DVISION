...
public class CategoryListRepository {
    ...
    public CategoryListRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<ArrayList<HashMap<String,String>>> getCategoryList(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().getCategoryList(requestBody);
