...
public class PublishPostRepository {
    ...
    public PublishPostRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<HashMap<String,String>> publishStatus(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().publishPost(requestBody);
