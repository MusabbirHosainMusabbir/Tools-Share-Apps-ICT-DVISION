...
public class AcceptOrRejectRepository {

    JSONObject reqJsonObj;
    public AcceptOrRejectRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<HashMap<String,String>> getAcceptOrRejectStatus(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().acceptOrReject(requestBody);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    responseMap.put("request_id",jsonObject.getJSONObject("response").getString("request_id"));
