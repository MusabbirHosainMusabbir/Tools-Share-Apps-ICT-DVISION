...
public class SendRequestRepository {

    JSONObject reqJsonObj;
    public SendRequestRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<HashMap<String,String>> getLoginStatus(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().doRequest(requestBody);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    responseMap.put("user_id",jsonObject.getJSONObject("response").getString("request_id"));
